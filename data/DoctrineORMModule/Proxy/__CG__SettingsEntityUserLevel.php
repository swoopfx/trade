 ...
 */
class UserLevel extends \Settings\Entity\UserLevel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Settings\\Entity\\UserLevel' . "\0" . 'id', '' . "\0" . 'Settings\\Entity\\UserLevel' . "\0" . 'level', '' . "\0" . 'Settings\\Entity\\UserLevel' . "\0" . 'icon'];
        }
