...
//         $this->serviceLocator->get("StorageContainer");
...
//             $this->storageContainer = $this->serviceLocator->get("StorageContainer");
        }
    ...
    public function getViewResult() {
        ...
        if (!($this->prevButtonDisabled && $isFirstStep)) {
            ...
            $this->prevButtonViewModel->setVariable("label", $this->translator->translate($this->buttonPrevLabel ? $this->buttonPrevLabel : Wizard::WIZARD_BUTTON_PREV_TEXT));
        ...
        $this->nextButtonViewModel->setVariable("label", $this->translator->translate($this->buttonNextLabel ? $this->buttonNextLabel : Wizard::WIZARD_BUTTON_NEXT_TEXT));
        ...
        if ($this->getSteps()->isPenultimate($this->stepCollectionIterator->current())) {
            $this->nextButtonViewModel->setVariable("label", $this->translator->translate($this->buttonFinishLabel ? $this->buttonFinishLabel : Wizard::WIZARD_BUTTON_FINISH_TEXT));
        }
        ...
        $innerHtml = new InnerHtml($this->selector, null, InnerHtml::ACTION_TYPE_REPLACE, $this->renderer);
    ...
    private function initConfiguration() {
        ...
        while ($iterator->valid()) {
            ...
            $currentStep->setServiceLocator($this->serviceLocator);
            $iterator->next();
        }
