...
class AdminController extends AbstractActionController
{
            ...
            if ($request->isPost()) {
                ...
                if ($form->isValid()) {
                    ...
                    $this->flashMessenger()->addSuccessMessage($this->getTranslatorHelper()
                        ->translate('User created Successfully'));
                    return $this->redirect()->toRoute('user-admin');
                }
            }
        } catch (\Exception $e) {
            return $this->getServiceLocator()
                ->get('csnuser_error_view')
                ->createErrorView($this->getTranslatorHelper()
                ->translate('Something went wrong during user creation! Please, try again later.'), $e, $this->getOptions()
                ->getDisplayExceptions(), false);
        }
    ...
    public function editUserAction()
    {
        ...
        try {
            ...
            return $this->getServiceLocator()
                ->get('csnuser_error_view')
                ->createErrorView($this->getTranslatorHelper()
                ->translate('Something went wrong during update user process! Please, try again later.'), $e, $this->getOptions()
                ->getDisplayExceptions(), false);
        }
    ...
    public function deleteUserAction()
    {
        ...
        try {
            ...
            return $this->getServiceLocator()
                ->get('csnuser_error_view')
                ->createErrorView($this->getTranslatorHelper()
                ->translate('Something went wrong during user delete process! Please, try again later.'), $e, $this->getOptions()
                ->getDisplayExceptions(), false);
        }
    ...
    public function setUserStateAction()
    {
        ...
        if ($id === 0 || $state === - 1) {
            $this->flashMessenger()->addErrorMessage($this->getTranslatorHelper()
                ->translate('User ID or state invalid'));
            return $this->redirect()->toRoute('user-admin');
        }
