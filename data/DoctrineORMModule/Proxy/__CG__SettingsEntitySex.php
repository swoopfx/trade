 ...
 */
class Sex extends \Settings\Entity\Sex implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Settings\\Entity\\Sex' . "\0" . 'id', '' . "\0" . 'Settings\\Entity\\Sex' . "\0" . 'sex'];
        }
